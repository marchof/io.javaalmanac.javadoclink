...
public abstract class JavaDocLinkTest {
	...
	static {
		...
		JDK_API_DOC.put("19", "https://docs.oracle.com/en/java/javase/19/docs/api/");
		JDK_API_DOC.put("20", "https://docs.oracle.com/en/java/javase/20/docs/api/");
		JDK_API_DOC.put("21", "https://docs.oracle.com/en/java/javase/21/docs/api/");
		JDK_API_DOC.put("22", "https://docs.oracle.com/en/java/javase/22/docs/api/");
		...
		JDK_API_DOC.put("25", "https://docs.oracle.com/en/java/javase/25/docs/api/");
		JDK_API_DOC.put("26", "https://docs.oracle.com/en/java/javase/26/docs/api/");
		JDK_API_DOC.put("27", "https://download.java.net/java/early_access/jdk27/docs/api/");
		JDK_API_DOC.put("28", "https://download.java.net/java/early_access/jdk28/docs/api/");
	}
